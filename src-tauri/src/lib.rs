...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::students::check_grade_promotion,
            commands::students::promote_grades,
            ...
            commands::billing::list_affected_bill_months,
            ...
            commands::notice::get_notice_layout,
            commands::notice::list_notice_layouts,
            ...
            commands::notice::notice_preview_default_path,
            commands::notice::save_notice_preview,
            commands::notice::open_notice_output_dir,
            commands::notice::open_notice_preview_dir,
            ...
            commands::export::export_billing,
