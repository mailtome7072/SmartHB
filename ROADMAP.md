...
| 현재 Phase | **Post-v1.1 UX 개선** — Sprint 19 진행 중 (그리드 정렬/스크롤 + 인쇄 캘린더 + 캘린더 표시 규칙 + 대시보드 레이아웃) |
| 다음 마일스톤 | v1.2.0 (Sprint 19 완료 후) |
...
### Sprint 19: 그리드 정렬/스크롤 통일 + 인쇄 캘린더 고도화 + 수업관리 표시 규칙 정비 + 대시보드 레이아웃 + 학년 자동승급 + 학교급 필터링 (2주) 🔄 진행 중
...
- ⬜ V310 마이그레이션 정상 적용 + cargo test + clippy --all-targets + lint + tsc + build 전수 통과
...
| M11: UX 개선 | Post-v1.1 | Sprint 19 | +38주 | 그리드 정렬/스크롤 + 인쇄 캘린더 + 학년 자동승급 + 학교급 필터링 |
