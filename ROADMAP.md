...
| 다음 마일스톤 | Phase 1.5 — 품질 안정화 (Sprint 4 진행 중) |
...
Phase 2 (학사+출결)  ← Phase 1.5 완료 필수
  ├── Sprint 5: 학사 스케줄 (3개월 캘린더 + 코드 3속성 + 교습기간)
  └── Sprint 6: 출결 생성 + 출결표 UI + 상태 토글 (캘린더 ADR)
...
## Phase 1.5: 품질 안정화 (Sprint 4) 🔄 진행 중

### Sprint 4: Phase 1 품질 안정화 — 스테이징 검증 14개 이슈 해소 (2주) 🔄 진행 중
