...
Phase 2 (학사+출결)  ← Phase 1 완료 필수
  ├── Sprint 4: 학사 스케줄 (3개월 캘린더 + 코드 3속성 + 교습기간)
  └── Sprint 5: 출결 생성 + 출결표 UI + 상태 토글 (캘린더 ADR)
...
## Phase 1: 인프라 + 기반 도메인 (Sprint 1~3) 📋 예정

> **3스프린트 이상 — phase-planner 후속 안건**
...
### Sprint 3: 원생 관리 프론트 + 초기 설정 마법사 (2주) 📋 예정
