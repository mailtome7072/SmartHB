...
// P1-1 (2026-06 코드리뷰): 기본 text-sm(14px)/h-8(32px) → text-base/h-11(44px) 상향.
// Button 사용처는 alert-dialog(확인 다이얼로그)뿐 — 위험 동작(삭제/퇴교/종료) 확인 버튼이
// 앱에서 가장 작던 역설 해소 (50대 접근성 기준: 본문 16px 하한·클릭 영역 44px, PRD §5.7).
