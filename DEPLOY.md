...
### Sprint 18 (2026-07-01)

브랜치: `sprint18 → master` 직접 머지 (단일 개발자 정책)

#### 자동 검증 완료 항목
- ✅ cargo test: 415 passed, 4 ignored (sprint-review 후 출결 동기화 회귀 테스트 1건 추가)
- ✅ cargo clippy --all-targets: 경고 없음
- ✅ cargo check --features cipher: 통과
- ✅ pnpm lint + tsc --noEmit + build: 전수 통과

#### 수동 검증 필요 항목
- ✅ sprint-review 에이전트 실행 (코드 리뷰 + 자동 검증 — 2026-07-01)
- ✅ pnpm tauri:dev 실행하여 앱 동작 수동 확인 (스테이징 검증 — 2026-07-02, 수동 검증 중 발견된 버그 10건 수정 포함)

이전 배포 기록: `docs/deploy-history/2026-06-30.md` (v1.0.1 Hotfix + Sprint 17)
