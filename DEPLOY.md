...
## 2026-07-02 | v1.1.0 | Sprint 17 + Sprint 18 프로덕션 배포

브랜치: `sprint17/sprint18 → master` 직접 머지 (단일 개발자 정책)

### 포함 스프린트
- Sprint 17: DB 안전성 개선, SyncStatus 제거, hourly 백업 간격 완화
- Sprint 18: 캘린더 UX 개선, 출결 자동 동기화, 교습일정 인쇄, 후속 버그 10건 수정

### 배포 상태
- ✅ master merge 완료 (68c9a9a)
...
이전 배포 기록: `docs/deploy-history/2026-07-02.md` (아카이빙 완료)
