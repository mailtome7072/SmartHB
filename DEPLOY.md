...
- ✅ package.json + Cargo.toml 버전 1.1.0 → 1.2.0 업데이트
- ✅ CHANGELOG.md [Unreleased] → [1.2.0] 전환
- ⬜ v1.2.0 태그 push → GitHub Actions 빌드 완료
- ⬜ GitHub Release 아티팩트 업로드 확인
  - ⬜ Windows: SmartHB_1.2.0_x64-setup.exe
  - ⬜ macOS: SmartHB_1.2.0_aarch64.dmg

### CV — 아티팩트 검증
- ⬜ gh release view v1.2.0 으로 Release 확인
- ⬜ 다운로드 URL 유효성 확인
- ⬜ 인스톨러 설치 테스트 (수동, 선택)
