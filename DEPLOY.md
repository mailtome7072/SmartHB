...
## 2026-05-23 | v0.3.1 | 프로덕션 배포

### 포함 스프린트
- Sprint 6: Phase 2 학사 스케줄 (3개월 캘린더, 교습기간, 코드 배치)
- Sprint 7: Phase 2 carry-over 해소 (Keychain 최적화, 교습기간 UX, 보안 패치 6건, post-review 38건 fix)

### 배포 상태
- ✅ develop → master merge 완료
- ⬜ v0.3.1 태그 push → GitHub Actions 빌드 완료
