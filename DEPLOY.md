...
## 2026-05-24 | v0.4.0 | Sprint 8 — Phase 2 프로덕션 배포

### 포함 스프린트
- Sprint 8: 출결 관리 (UC-3) + Sprint 7 carry-over 해소 + V107 FK 보강

### 배포 상태
- ✅ CHANGELOG.md [0.4.0] 버전 전환 완료
- ✅ 버전 bump: package.json / tauri.conf.json / Cargo.toml → 0.4.0
- ✅ develop → master 직접 머지 완료 (단일 개발자 정책)
- ✅ v0.4.0 태그 push → GitHub Actions CD 빌드 완료 (run 26349179522, 16m46s, success)
- ✅ GitHub Release 아티팩트 업로드 확인 (총 4건, publishedAt: 2026-05-24T02:09:39Z)
  - ✅ Windows: `SmartHB_0.4.0_x64-setup.exe` (4.7MB) + `SmartHB_0.4.0_x64_en-US.msi` (5.9MB)
  - ✅ macOS: `SmartHB_0.4.0_aarch64.dmg` (7.4MB) + `SmartHB_aarch64.app.tar.gz` (6.5MB, auto-update bundle)

### CV — 아티팩트 검증
- ✅ gh release view v0.4.0 으로 Release 확인 (https://github.com/mailtome7072/SmartHB/releases/tag/v0.4.0)
- ✅ 다운로드 URL 유효성 확인 (4 artifacts state=uploaded, sha256 확인됨)
- ⬜ 인스톨러 설치 테스트 (수동, 선택)
...
스테이징 기록: `docs/deploy-history/2026-05-24.md`
