...
### Sprint 14 (2026-06-06)

대시보드(위젯 7종+알림 4종) + 데이터 자가 진단(7종 검사+자동/수동+12개월 이력) + 엑셀 내보내기(3종) + 복원 리허설 + 원생 생년월일 + V303~V305 마이그레이션.

- ⬜ sprint-review 에이전트 실행 (코드 리뷰 + 자동 검증)
- ⬜ sprint14 → develop 직접 머지 (단일 개발자 정책)
- ⬜ pnpm tauri:dev 실행하여 앱 동작 수동 확인 (스테이징 검증)

이전 배포 기록: `docs/deploy-history/2026-06-06.md` (Sprint 13)
