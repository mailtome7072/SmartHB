...
- [프로젝트 기술 스택](tech-stack.md) -- Tauri 2 + Next.js 15 + SQLite/sqlx 0.8, 최신 마이그레이션 V305
...
- 마지막 완료 스프린트: Sprint 15 (2026-06-07)
- 다음 스프린트 번호: 16 (계획 수립 완료)
...
- **Phase 구조**: 6 Phase (Phase 5 단원평가 취소). Phase 1~5 완료, Phase 6 Sprint 15 완료 + Sprint 16 진행 중
