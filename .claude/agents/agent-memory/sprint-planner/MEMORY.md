...
- [Sprint 17 계획](sprint17-context.md) -- Post-v1.0 유지보수. DB 안전성 잔여 수정 3건 + 정책 간소화 3건. Hotfix 후속. 16h 예상
- [Sprint 16 계획](sprint16-plan.md) -- Phase 6 마지막, UAT+v1.0 준비, Sprint 15 이연(T7/T8/T9) 흡수, CSV 가져오기
- [프로젝트 기술 스택](tech-stack.md) -- Tauri 2 + Next.js 15 + SQLite/sqlx 0.8, v1.0.0 릴리즈 완료(2026-06-12), 최신 마이그레이션 V307
...
- 마지막 완료 스프린트: Sprint 18 (2026-07-01)
- 다음 스프린트 번호: 19 (계획 수립 완료)
...
- Sprint 17 계획 수립: 2026-06-30 (Post-v1.0 DB 안전성 + 정책 간소화 -- T1~T7 7개 Task, 16h 예상, 신규 의존성/DB마이그레이션 없음)
- Sprint 16 계획 수립: 2026-06-08 (UAT+v1.0 릴리즈 준비 -- T0~T10 11개 Task, 40h 예상, MUST 28h + SHOULD 7h + COULD 2h. CSV 가져오기(encoding_rs/csv 신규 의존성), 배포 사용자 지시 대기. DB 마이그레이션 없음)
- Sprint 15 계획 수립: 2026-06-07, rev3 (양 OS 빌드 검증 + 접근성 감사 + 성능 최적화 + 교습소 정보(이미지2종 포함 6h) + 가변 버퍼 3h -- T0~T9 10개 Task, 38h 예상, 신규 의존성 없음, DB 마이그레이션 없음. 내보내기 비번 보호 완전 취소. 빌드 검증은 성능 최적화 뒤 배치)
...
- **Phase 구조**: 6 Phase (Phase 5 단원평가 취소). Phase 1~6 완료 (v1.0.0 릴리즈). Post-v1.1 Sprint 19 진행 중
