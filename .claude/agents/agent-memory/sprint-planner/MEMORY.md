...
- [Sprint 현황](sprint-status.md) -- Sprint 11 계획 수립 완료, Phase 4 첫 sprint (청구+수납)
- [마이그레이션 번호 정책](migration-numbering.md) -- V108 완료, Sprint 11에서 V109 사용 (bills + payments)
- [Capacity 패턴](capacity-pattern.md) -- Sprint 9(38h계획/52h실측, +37%) → Sprint 10(실측 22.5h) → Sprint 11(계획 30.5h/34h capacity)
- [Velocity 데이터](velocity.md) -- 시각 검증 버퍼 6h 별도 예약 패턴 정착 (A50)
- [Velocity 참조](velocity-reference.md) -- Sprint 10 실측 22.5h, Capacity 34h 기준

## 스프린트 현황

<!-- sprint-close 완료 시 업데이트 -->
- 마지막 완료 스프린트: Sprint 10 (2026-05-28, v0.5.0 배포)
- 현재 스프린트: Sprint 11 (계획 수립 완료, 구현 대기)
- 다음 스프린트 번호: 12
