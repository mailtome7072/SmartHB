...
description: "Sprint 16 진행 중 — sprint16 브랜치. T0+T1+T2+공지문보강+공지문 교습일정 달력 완료(작업트리 clean, ⚠️origin 대비 ahead 5·미push). 다음 = 공지문 추가요청 대응 또는 T3(DB폴더변경) 이어가기. ⚠️배포 금지. 새 세션/새 PC 진입 시 가장 먼저 확인"
metadata:
  node_type: memory
  type: project
...
**현재 위치(2026-06-10)**: **sprint16 브랜치**, 작업트리 clean. ⚠️ **origin/sprint16 대비 ahead 5 — 미push**(다른 PC 릴레이 전 `git push origin sprint16` 필요). develop 미머지.
