...
- [Sprint 다음 세션](sprint-next-session.md) — Sprint 9 Session #5 완료 (T1~T5, 5/9, cargo test off 247 / on 133, lint/tsc clean). 백엔드 IPC 6종 + TS 래퍼 + 타입 매핑 완성. 다음: `/sprint-dev 9` → Session #6 (T6 보강 등록 개별 UI)
