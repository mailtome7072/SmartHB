...
- ✅ 저장 경로: `{data_root}/output/{공지문이름}/{YYMM}/{이름}_{YYMM}_{원생}.png` (경로 개편)
- ✅ 청구액 천단위 콤마 표기 (AC-4.10-1)
- ✅ 동일 월 재생성 시 덮어쓰기 확인 다이얼로그 (AC-4.10-2)
- ✅ 50장 생성 < 30초 (PRD §5.6) — Canvas 2D 직접 렌더로 성능 충족
...
- ✅ ROADMAP.md Sprint 12 상태 업데이트 (2026-06-02)
- ✅ CHANGELOG.md 업데이트 (2026-06-02)
